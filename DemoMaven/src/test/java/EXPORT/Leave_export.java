...
public class Leave_export
{
	...
	public  void Leave_export(WebDriver driver,String HtmlOutputFileName,TestHTMLReporter6 TH3  )throws Exception
	{  
			  this.driver=driver;
	...
	{  
		...
		String str1="TC05 Leave List Export" + str;
		...
		Leave_export LE =new Leave_export();
		LE.Leave_export(driver, str1, TH3);;
		LE.Leave_export();
