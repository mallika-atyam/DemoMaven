...
public class Leavelist
{
	...
	public  void Leavelist(WebDriver driver )throws Exception
	{  
			  this.driver=driver;
	}
	...
	{  
		...
		AE.ExportLeaveList();
			...
			// Ends method for  VacancySearch
				...
				public  void ExportLeaveList()throws Exception
				{ 
							    	  ...
							    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
							    	   {
							    	      ...
							    	      //  System.out.println("Cell Text Value is: " + valueIneed1);
							    	        ...
							    	        if (valueIneed1 !=null)
							    	        eat.PutCellData( "E://OrangeHrm//TC05_Leavelist.xls","Sheet5",i,k,valueIneed1);
							    	        else
							    	        eat.PutCellData( "E://OrangeHrm//TC05_Leavelist.xls","Sheet5",i,k,"Blank Data");
