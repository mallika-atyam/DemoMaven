...
public class Admin_Qualification_languages
{
	...
	public  void Admin_Qualification_languages_Export(WebDriver driver )throws Exception
	{  
			  this.driver=driver;
	}
	...
	public void call_allmethods(int iRow)throws Exception
	{
		...
		Admin_Qualification_languages aql=new Admin_Qualification_languages();
		aql.Admin_Qualification_languages_Export(driver);
		aql.Admin_Qualification_languages();
			...
			public  void Admin_Qualification_languages()throws Exception
			{
				 {
				 ...
				 driver.findElement(By.xpath(OR.languages)).click();
				 
				 
				  //No. of columns
			        List  columns = driver.findElements(By.xpath(OR.languages_columns)); 
			        System.out.println("No of columns are : " + columns.size());
			        
			        //No.of rows 
			        List  rows = driver.findElements(By.xpath(OR.languages_rows)); 
				    	  ...
				    	  for ( int j=2 ,k=0; j<=columns.size() ;j++,k++)
				    	   {
				    	      ...
				    	      //  System.out.println("Cell Text Value is: " + valueIneed1);
				    	        ...
				    	        if (valueIneed1 !=null)
				    	        eat1.PutCellData( "E://OrangeHrm//TC05_USERMANAGEMENT.xls","Sheet3",i,k,valueIneed1);
				    	        else
				    	        eat1.PutCellData( "E://OrangeHrm//TC05_USERMANAGEMENT.xls","Sheet3",i,k,"Blank Data");
